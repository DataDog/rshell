...
func TestEvalMminCeiling(t *testing.T) {
	...
	tests := []struct {
		...
		{"5m gt 4", 5 * time.Minute, 4, 1, true},
		{"5m lt 6", 5 * time.Minute, 6, -1, true},
