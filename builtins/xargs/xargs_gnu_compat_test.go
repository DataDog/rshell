...
//
// Both GNU xargs and rshell exit 1 for unrecognised flags; this test
// confirms rshell's pflag integration produces the expected exit code and
// a non-empty stderr message.
