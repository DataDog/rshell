...
- ✅ AllowedPaths filesystem sandboxing — restricts all file access to specified directories or individual files; individual file paths grant access to only that file (not its parent directory or siblings)
